...
### 视频讲解
- 本题链接: [Youtube ](https://youtu.be/{{youtube_video_number}}), [B站]({{bilibili_video_link}})
<iframe width="560" height="315" src="https://www.youtube.com/embed/{{youtube_video_number}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
### 我的 Leetcode 讲解频道
- [Youtube小小福LeetCode讲解频道]({{youtube_channel_link}})


### 代码链接
- [Github本题解析链接]({{github_code_link}})
